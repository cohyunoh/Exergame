// Inside obj_exercise Step Event
...
obj_running.visible = (_current_exercise == "running");
obj_lunges.visible = (_current_exercise == "lunges");
obj_jumping_jacks.visible = (_current_exercise == "jumping_jacks");
obj_high_knees.visible = (_current_exercise == "high_knees");
obj_butt_kicks.visible = (_current_exercise == "butt_kicks");
